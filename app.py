...
def employee():
    ...
    #employees will store all the data extracted and use later
...
def notes():
    ...
    #notes_list will store all the data extracted and use later
...
#Employee Section - Add Employee Details
